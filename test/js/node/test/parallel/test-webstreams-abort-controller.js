...
// Bun: skipped. Bun's ReadableStream async iterator batches the buffered queue
// (readMany), so the source's close() takes effect before the abort fires and
// erroring an already-closed stream is a no-op; the iteration completes instead
// of rejecting with AbortError.
