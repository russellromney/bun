...
unsafe extern "C" {
    ...
    pub fn SSL_CTX_get_tlsext_ticket_keys(ctx: *mut SSL_CTX, out: *mut c_void, len: usize) -> c_int;
    pub fn SSL_CTX_set_tlsext_ticket_keys(ctx: *mut SSL_CTX, r#in: *const c_void, len: usize) -> c_int;
